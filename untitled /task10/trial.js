...
$(function(){
    ...
    // });
        ...
        input.get(0).addEventListener("keypress",function(){
            if(event.keyCode == 13) {
                button.get(0).click();
            }
        });
